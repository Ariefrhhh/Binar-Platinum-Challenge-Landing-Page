      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <h2 className="mb-4 fs-1 fw-bold sectionTitle">Best Car Rental for any kind of trip in Majalengka!</h2>
            <p className="fs-5 fw-bold sectionSubtitle">
              Sewa mobil di Majalengka bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain, kondisi mobil baru, serta kualitas pelayanan terbaik untuk perjalanan wisata, bisnis, wedding, meeting, dll.
            </p>
