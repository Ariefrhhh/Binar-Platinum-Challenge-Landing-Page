        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto fs-5 fw-normal">
            <li className="nav-item">
              <a className="nav-link active ms-2" href="#about" key="navbar-1">
                Our Services
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link active ms-2" href="#whyus" key="navbar-2">
                Why Us
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link active ms-2" href="#testimonial" key="navbar-3">
                Testimonial
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link active ms-2" href="#faq" key="navbar-4">
                FAQ
              </a>
            </li>
            <button className="registerButton ms-3 mt-1" key="navbar-4" onClick={handleRegisterButton}>
              Register
            </button>
          </ul>
        </div>
